...
class Component extends HTMLElement {
    ...
    /**
     * Creates Component observable data, that allows to listen changes over all 
     * data properties. When data content changes, {@link Component#_dataHandler} 
     * is called.
     * @ignore
     */
    _initData() {
    ...
    /**
     * Callback function for connected event. It runs {@link Component#created} 
     * method, render function and runs {@link Component#rendered} method, 
     ...
     * {@link Component#destroyed} method.
     * @ignore
     */
     ...
     * @param  {Component} definition - Custom class that extends {@link Component} class.
     * @example
     *  class MainComponent extends Component { 
     *      // ...
     *  }
